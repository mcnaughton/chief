...
define('src/js/load',['src/js/bridge'], function(csInterface) {
    return {
        file: function (pPath) {
...
define("vulcan", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.Vulcan;
    };
}(this)));

define('src/js/adobe',['src/js/bridge', 'src/js/load', 'vulcan'], function(bridge, load) {
    var stack = {};
    if (bridge) {
        load.directory("jsx");
